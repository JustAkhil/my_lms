...
class InProgressSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inProgress = DummyDataService.courses
        .where(
          (courses) =>
              courses.lessons.any((lesson) => lesson.isCompleted) &&
              !courses.lessons.every((lesson) => lesson.isCompleted),
        )
        .toList();
    return Column(
      ...
      children: [
        ...
        if (inProgress.isEmpty) const SizedBox.shrink(),

        Column(
          children: inProgress.map((course) {
              ...
              child: Container(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    borderRadius: BorderRadius.circular(16),
                    onTap: () =>
                        _handleCourseTap(context, course.id, completedLessons),
                    child: Padding(
